...
namespace AttributeDI.Analyzer
{
    ...
    {
        public const string DiagnosticId = "AttributeDI";
        ...
        private static void AnalyzeSymbol(SymbolAnalysisContext context)
        {
            ...
            if (attributes.Length > 0 && attributes.Any(x => x.AttributeClass.Name == "ServiceRegistrationAttribute"))
            {
        ...
        {
            return symbol.GetAttributes().Any(x => x.AttributeClass.Name == "ServiceRegistrationAttribute");
        }
