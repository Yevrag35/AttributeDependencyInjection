...
/// </summary>
public sealed class DuplicatedServiceException : AttributeDIStartupException
{
    private const string DEFAULT_MSG = "A service was attempted to be registered twice in the specified Dependency Injection container and this was not intended -> '{0}'";
    ...
    {
        return string.Format(DEFAULT_MSG, serviceType.GetName());
    }
}
